...
class DeleteTemplate
{
    ...
    protected static function makeSure(string $dir, string $nama): void
    {
        ...
        if (file_exists($dir . "/" . $nama . ".latte")) {
            echo "\n\e[0;101m Hati-hati! \e[0m\nYakin ingin menghapus file " . $nama . ".latte?\e[0m\n";
            ...
            if ($jawab == "Ya" || $jawab == "Y" || $jawab == "ya" || $jawab == "y" || $jawab == "Yes" || $jawab == "yes") {
                unlink($dir . "/" . $nama . ".latte");
                if(count(scandir($dir)) == 2) {
                    rmdir($dir);
                }
                echo "\n\e[0m\e[0;101m Dihapus! \e[0m\n";
                echo "\e[0;36mLokasi:\e[0m \e[9m" . $folder . "/" . $nama . ".latte\e[0m\n\n";
                die();
            } else {
            ...
            echo "\n\e[0m\e[0;101m file " . $nama . ".latte Tidak ditemukan! \e[0m\n\n";
            die();
        }
    }
}
