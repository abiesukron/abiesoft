...
';
			...
			echo LR\Filters::escapeHtmlAttr($url) /* line 62 */;
			echo '/';
			echo LR\Filters::escapeHtmlAttr($sessionkey) /* line 62 */;
...
';
		if ($totalusers > 0) /* line 77 */ {
			echo '    <script>
    loadTabel([';
			echo LR\Filters::escapeJs($url) /* line 79 */;
			echo ',';
			echo LR\Filters::escapeJs($apikey) /* line 79 */;
			echo ',\'users\',';
			echo LR\Filters::escapeJs($csrf) /* line 79 */;
			echo ']);
    </script>
';
		}
