...
final class Template50c5a0346e extends Latte\Runtime\Template
{
	public const Source = 'D:\\Programming\\Project\\test\\abiesoft\\vendor\\abiesoft\\Http/../../../templates/theme/auth/login.latte';
...
';
		if ($google == 1) /* line 60 */ {
			...
			echo LR\Filters::escapeHtmlAttr($google_url_login) /* line 61 */;
			echo '">
...
';
		if ($registrasi == 1) /* line 67 */ {
			...
			echo LR\Filters::escapeHtmlAttr($url) /* line 71 */;
			echo '/registrasi">
