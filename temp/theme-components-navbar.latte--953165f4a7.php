...
final class Template953165f4a7 extends Latte\Runtime\Template
{
    ...
    <div class="user-info">
        <button class="photo">
            <div><img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url . $photo_)) /* line 11 */;
		echo '" id="pp1"></div>
        </button>
        <div id="pp1-menu" class="menu">
            <div class=\'email\' id="emailArea1">';
		echo LR\Filters::escapeHtmlText($email_) /* line 14 */;
		echo '</div>
            <div class=\'photo\'>
                <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($url . $photo_)) /* line 16 */;
		echo '" id="pp3">
            </div>
            <div class="edit" id="editphoto"><i class="las la-pen"></i></div>
            <div class=\'nama\' id="namaArea1">';
		echo LR\Filters::escapeHtmlText($nama_) /* line 19 */;
		echo '</div>
		...
		echo '/profile/@';
		echo LR\Filters::escapeHtmlAttr($username_) /* line 20 */;
